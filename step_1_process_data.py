...
def save_xml(image_name, name_list, xmin_list, ymin_list, xmax_list, ymax_list):
    ...
    new_panda = data_panda.drop_duplicates(['name_list', 'xmin_list', 'ymin_list', 'xmax_list',   'ymax_list'],keep='first')
...
def dealed_detection(row):
    ...
    for i in detection:
        ...
        name_list.append('AB')
    save_xml(list(row['temp'])[0], name_list, xmin_list, ymin_list, xmax_list, ymax_list)
